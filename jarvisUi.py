...
class Ui_jarvisUi(object):
    def setupUi(self, jarvisUi):
        ...
        jarvisUi.resize(1376, 855)
        self.centralwidget = QtWidgets.QWidget(jarvisUi)
        self.centralwidget.setObjectName("centralwidget")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(0, 0, 1371, 851))
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("D:\JARVIS AI PROJECT/7LP8.gif"))
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setGeometry(QtCore.QRect(40, 50, 501, 111))
        self.label_2.setText("")
        self.label_2.setPixmap(QtGui.QPixmap("D:/JARVIS AI PROJECT/Jarvis_Loading_Screen.gif"))
        self.label_2.setObjectName("label_2")
        self.pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton.setGeometry(QtCore.QRect(610, 750, 111, 61))
        font = QtGui.QFont()
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(720, 750, 111, 61))
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.textBrowser.setGeometry(QtCore.QRect(880, 30, 191, 91))
...
"font-size:20px;")
        ...
        self.textBrowser_2.setGeometry(QtCore.QRect(1070, 30, 191, 91))
